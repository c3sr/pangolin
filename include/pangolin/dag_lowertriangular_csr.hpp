...
struct VertexSet {
  ...
  size_t count(const Int &e) const noexcept { return set_.count(e); }

  void insert(const Int &e) { set_.insert(e); }
...
public:
  ...
  size_t num_edges() const { return destinationIndices_.size(); }
