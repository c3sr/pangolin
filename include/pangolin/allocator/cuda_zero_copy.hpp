...
bool operator==(const CUDAZeroCopyAllocator<T> &, const CUDAZeroCopyAllocator<U> &) { return true; }
template <class T, class U>
bool operator!=(const CUDAZeroCopyAllocator<T> &, const CUDAZeroCopyAllocator<U> &) { return false; }