...
public:
  virtual const index_type *row_offsets() const override { return rowOffsets_.data(); }
  ...
  virtual size_t num_rows() const { return rowOffsets_.empty() ? 0 : rowOffsets_.size() - 1; }
